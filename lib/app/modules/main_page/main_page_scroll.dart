...
import 'package:polarstar_flutter/app/modules/main_page/widgets/boardPreview.dart';
import 'package:polarstar_flutter/app/modules/main_page/widgets/hotBoardPreview.dart';
            ...
            child: Obx(() {
              if (!mainController.dataAvailalbe) {
                ...
                return Obx(() {
                  ...
                  double tabbar_height = 25 + 16.0 + 14.0;
                                                              ...
                                                              ? Container(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    return ListView.builder(
                                                                        itemCount: mainController.followingCommunity.length,
                                                                        shrinkWrap: true,
                                                                        ...
                                                                        itemBuilder: (BuildContext context, int index) {
                                                                          ...
                                                                          if (boardInfo ==
                                                                              null) {
                                                                            mainController.deleteFollowingCommunity(int.parse(target_community_id));
                                                                            return Container();
                                                                          }
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child: Column(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text("跟踪社区",
                                                                                overflow: TextOverflow.ellipsis,
                                                                                style: const TextStyle(overflow: TextOverflow.ellipsis, color: const Color(0xffd6d4d4), fontWeight: FontWeight.w700, fontFamily: "NotoSansSC", fontStyle: FontStyle.normal, fontSize: 10.0),
                                                                                textAlign: TextAlign.center)
                                                                          ]),
                                                                    ),
                                                                  ),
