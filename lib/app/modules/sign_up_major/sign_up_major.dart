...
class SigunUpCommunityRule extends StatefulWidget {
  ...
  @override
  State<SigunUpCommunityRule> createState() => _SigunUpCommunityRuleState();
}

class _SigunUpCommunityRuleState extends State<SigunUpCommunityRule> {
  ...
  Widget build(BuildContext context) {
    ...
    if (Get.parameters.containsKey("isSignUp")) {
      if (Get.parameters["isSignUp"].toString() == "true") {
        setState(() {
    ...
    print(widget.isSignUp != null && widget.isSignUp == true);
    return Container(
      color: Colors.white,
      child: SafeArea(
          top: false,
